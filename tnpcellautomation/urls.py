...
from user.views import admin_view_feedback, home_view, prof_register_view, student_register_view, register_view, prof_register_view, profile_view, search_users, get_feedback
...
from learningmaterial.views import learning_material_home, topic_info, topics_view, add_concept, edit_concept, delete_concept, add_topic, edit_topic, delete_topic
from qa.views import add_answer, qa_home, add_question, display_answers
from chat.views import index, room, delete_room
...
urlpatterns = [
    ...
    path('view_feedback', admin_view_feedback, name="view_feedback"),
    ...
    path('stats/', show_total, name="stats_page"),
    ...
    path('chat/<str:room_code>/', room, name="chat"),
    path('delete_room/<str:room_code>/', delete_room, name="delete-room"),
]
